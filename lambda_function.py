...
TICKET_PREFIX = os.environ.get("TICKET_PREFIX", "GNAF")
...
def register_participant(
    ...
    """Register a participant and issue a ticket."""
    ...
    event_result = events_table.get_item(
        Key={
            "eventId": event_id
        }
    )

    event_item = event_result.get(
        "Item"
    )
